...
struct Durability {
   ...
   constexpr Durability(double n) : numericValue{n} {
...
struct CPU {
   ...
   Rate getWriteOps() const { return Rate::secondly((count * speed) / cyclesPerWrite); }
   Rate getReadOps() const { return Rate::secondly((count * speed) / cyclesPerRead); }
   Rate getOps() const { return Rate::secondly((count * speed) / cyclesPerWrite); }
};
//--------------------------------------------------------------------------------
struct Memory {
...
struct EBS {
  ...
  static constexpr double gp3_durability = 0.998;
  static constexpr double gp2_durability = 0.998;
  static constexpr double io2x_durability = 0.99999;
  static constexpr double io2_durability = 0.99999;
  static constexpr double io1_durability = 0.998;
